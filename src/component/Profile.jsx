  ...
  return (
    <div className="relative -z-20">
      <div className="w-full">
        <div className="bg-black rounded-4xl border-2 border-white m-2 p-1">
        ...
        <img
          src={Profiles}
          alt="Profile"
          className=" border-2 border-white rounded-full my-10"
        />
      </div>
      <div className="text-white text-[3rem] flex gap-10 justify-center absolute bottom-[8px] left-[50%] -translate-x-[50%] items-center font-serif">
